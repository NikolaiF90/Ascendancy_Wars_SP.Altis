...
Revive_BleedoutTime = 60; // Time (in minutes) for incapacitated unit to die if not being revived
Revive_Honor = 1; // Honor gained for reviving another unit

configureReviveDone = true;