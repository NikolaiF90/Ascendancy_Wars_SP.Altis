...
if (isNil { _slot }) then
{
    ["listExistingVariables","Listing variables for all saves"] call F90_fnc_debug;
}
else
{
    ["listExistingVariables",format ["Listing variables for save slot %1", _slot]] call F90_fnc_debug;
};
